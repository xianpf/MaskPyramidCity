...
class CategoryPyramid(nn.Module):
    def __init__(self, cfg):
        super(CategoryPyramid, self).__init__()
        num_classes = cfg.DATALOADER.NUM_CLASSES
        self.init_conv = double_conv(2+256, 16)
        self.up1 = up(256+16, 16)
        self.up2 = up(256+16, 16)
        self.up3 = up(256+16, 16)
        self.up4 = up(256+16, 16)
        self.up5 = up(256+16, 16)
        self.up256 = up(128+16, 16)
        self.up513 = up(64+16, 16)
