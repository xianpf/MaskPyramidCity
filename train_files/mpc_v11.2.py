            ...
            if self.training:
                ...
                for sem_lvl in range(6):
                    ...
                    for pos_t in pos_list:
                        ...
                        # output_dict['show_img'] = self.make_observation(image, sematic_out=sematic_out,
                        #         sem_targets=targets['label'], ins_target=targets['instance'],
                        #         ins_out = ins_out, ins_out_label=None, pyramids=ins_pyramids,
                        #         s_sem_tar=False, s_ins_tar=True, s_sem_out=True, s_ins_out=False,
                        #         s_run_mask=True, run_mask=running_mask)
                        # self.show_image(image, output_dict, show_via='plt')
...
def main():
    ...
    cfg.merge_from_list(['MODEL.WEIGHT', 'run/mpc_v11.1_1/Every_5_model_Epoch_40.pth'])
