...
class MaskPyramids(nn.Module):
    def __init__(self, cfg):
        ...
        self.up3 = up(512, 256)
        self.up4 = up(512, 256)
        self.up5 = up(256+128, 256)
        self.up6 = up(256+64, 256)
        # self.up7 = up(512, 256)
    ...
    def forward(self, image, targets=None):
        ...
        down_features = [x1, x2, x3, x4, x5, x6, x7]
        x_sematic = self.up1(x7, x6)
        x_sematic = self.up2(x_sematic, x5)
        x_sematic = self.up3(x_sematic, x4)
        x_sematic = self.up4(x_sematic, x3)
        x_sematic = self.up5(x_sematic, x2)
        x_sematic = self.up6(x_sematic, x1)
